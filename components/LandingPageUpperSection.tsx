			...
			<div className="grid gap-14 sm:m-3 sm:grid-cols-2 sm:items-center">
				<div className="sm:grid-rows m-4 grid gap-3">
					...
					<div className="flex space-x-4">
						<button className="focus:ring-primary items-center rounded-md bg-slate-100 text-green-600 px-4 py-2 shadow transition-colors hover:bg-green-600/90 hover:text-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2">
							Get Started
						</button>
